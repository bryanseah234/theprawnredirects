...
The Prawn redirects site pending fuller documentation and setup notes. The current Phase 3 pass standardises repository hygiene without inventing implementation details beyond what is visible in the repository.
